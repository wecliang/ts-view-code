  ...
  var JSONCompletion = function() {
    ...
    JSONCompletion2.prototype.doComplete = function(document2, position, doc) {
      ...
      return this.schemaService.getSchemaForResource(document2.uri, doc).then(function(schema2) {
        ...
        var types3 = {};
        if (schema2) {
          _this.getValueCompletions(schema2, doc, node, offset, document2, collector, types3);
        } else {
    ...
    JSONCompletion2.prototype.getValueCompletions = function(schema2, doc, node, offset, document2, collector, types3) {
      var offsetForSeparator = offset;
